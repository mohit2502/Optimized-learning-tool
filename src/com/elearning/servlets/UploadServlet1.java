			...
			for (FileItem file : multiparts) {
								...
								+ hashkey + "'");
				{
					if (rs.next()) {
						...
						String ACCESS_TOKEN = "D0V6kxZYzaAAAAAAAAAAfVeSysoRXBYrXC4axBa95TYoZK3dZUuO8zKQy4Cu7b1B";
					...
					int i = 0;
					if (k == 0) {
						i = db.updateQuery("insert into filelog(filename,filesize,hashkey,uid,displayname) values('"
								+ filename
								+ "','"
								+ sz
								+ "','"
