...
<body style="background-image: url('image/divbg3.jpg');">
	<%
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="dropdown">
					<li><a href="" onclick="TruncateDatabase()" style="color:black">Truncate Database</a></li>
					<li><a href="LogoutServlet" style="color:black">Sign Out</a></li>
				</ul>
